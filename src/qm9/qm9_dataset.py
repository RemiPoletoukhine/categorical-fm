...
from src.qm9.abstract_dataset import MolecularDataModule, AbstractDatasetInfos
from src.qm9.rdkit_functions import mol2smiles, build_molecule_with_partial_charges, compute_molecular_metrics
...
class QM9DataModule(MolecularDataModule):
    def __init__(self, cfg):
        ...
        datasets = {'train': QM9Dataset(stage='train', root=root_path, remove_h=cfg['remove_h'],
                                        target_prop=None, transform=RemoveYTransform()),
                    'val': QM9Dataset(stage='val', root=root_path, remove_h=cfg['remove_h'],
                                      target_prop=None, transform=RemoveYTransform()),
                    'test': QM9Dataset(stage='test', root=root_path, remove_h=cfg['remove_h'],
                                       target_prop=None, transform=RemoveYTransform())}
