...
def objective(
    ...
    Args:
        ...
        model (DirichletFlow): The DirichletFlow model.
...
def hyperparam_tuning(
    ...
    """
    Hyperparameter tuning for the DirichletFlow model.
    ...
    study = optuna.create_study(
        direction="minimize",
        storage="sqlite:///optuna_logs/Trial_{}.sqlite3".format(datetime.now().strftime("%Y-%m-%d_%H-%M-%S")),
        study_name="DirichletFlow",
    )
